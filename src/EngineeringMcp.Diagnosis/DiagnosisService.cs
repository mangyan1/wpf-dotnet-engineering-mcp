...
namespace EngineeringMcp.Diagnosis;

public interface IDiagnosisService
{
    Task<ToolResult<DiagnosisReport>> DiagnoseObserveAsync(
        int wpfProcessId,
        UiSelector selector,
    ...
    Task<ToolResult<DiagnosisReport>> DiagnoseClickAsync(
        int wpfProcessId,
        UiSelector selector,
        int? backendProcessId = null,
        string? sourceRoot = null,
...
public sealed class DiagnosisService(
    ...
    ISourceIntelligenceService source) : IDiagnosisService
{
